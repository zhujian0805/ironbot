...
Document the YAML-based permission system that controls access to tools, skills, and commands using a default deny model with explicit allow rules and comprehensive audit logging.
