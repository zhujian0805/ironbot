...
**Language/Version**: [e.g., TypeScript 5.x, Swift 5.9, Rust 1.75 or NEEDS CLARIFICATION]
**Primary Dependencies**: [e.g., Slack Bolt, UIKit, LLVM or NEEDS CLARIFICATION]
**Storage**: [if applicable, e.g., PostgreSQL, CoreData, files or N/A]
**Testing**: [e.g., bun test, XCTest, cargo test or NEEDS CLARIFICATION]
